	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/invite/summary", controller.GetInviteSummary)
				selfRoute.GET("/invite/users", controller.GetInviteUsers)
				selfRoute.GET("/invite/rebates", controller.GetInviteRebates)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/invite/summary", controller.AdminGetInviteSummary)
				adminRoute.GET("/:id/invite/users", controller.AdminGetInviteUsers)
				adminRoute.GET("/:id/invite/rebates", controller.AdminGetInviteRebates)
				adminRoute.GET("/invite/:id/summary", controller.AdminGetInviteSummary)
				adminRoute.GET("/invite/:id/users", controller.AdminGetInviteUsers)
				adminRoute.GET("/invite/:id/rebates", controller.AdminGetInviteRebates)
