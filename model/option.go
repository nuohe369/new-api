...
func InitOptionMap() {
	...
	common.OptionMap["InviteTopupRebateRate"] = strconv.Itoa(common.InviteTopupRebateRate)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviteTopupRebateRate":
		common.InviteTopupRebateRate, _ = strconv.Atoi(value)
